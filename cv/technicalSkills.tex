...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.0in, label={}]
    \small{\item{
     ...
     \vspace{4pt}
     \textbf{\normalsize{Technologies :}}{\normalsize{ PyTorch, PyTorch Lightning, Hydra, Scikit-Learn, Pandas, MySQL, PostgreSQL, Langchain, Docker, Tableau, Seaborn, FastAPI, React, NodeJs, Github Actions, Selenium, Google Cloud, BeautifulSoup4, Apache Kafka, Git, Tailwind Css, MS Office}} 
    }}
